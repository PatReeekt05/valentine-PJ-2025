...
const CONFIG = {
    ...
    colors: {
        backgroundStart: "#fff5e4",      // Background gradient start
        backgroundEnd: "#ffc4c4",        // Background gradient end
        buttonBackground: "#ffc4c4",     // Button color
        buttonHover: "#ee6983",          // Button hover color
        textColor: "#850e35"            // Text color
    },
